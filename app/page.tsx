          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="space-y-4">
                ...
                我們致力於提供基督教全人發展的教育環境，培養孩子的品格、學習習慣和創造力。我們相信，每一位孩子都是上帝獨特的創造，值得被用愛心和智慧悉心培育。在信仰的根基上，我們設計結合理性與感性、知識與品格、學術與藝術的教學內容，幫助孩子在身心靈各種健康成長。透過小班制互動、啟發式教學與家庭夥伴關係的建立，角聲教育事工不僅追求學業上的進步，更重視內在品格的塑造與對世界的好奇與關懷，培養有責任感、有想像力、有信仰根基的新一代。
                </p>
